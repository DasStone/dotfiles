if status is-interactive
    ...
    # TeX Live
    fish_add_path -g "$HOME/.local/texlive/2026/bin/x86_64-linux/"
    fish_add_path -g MANPATH $MANPATH "$HOME/.local/texlive/2026/texmf-dist/doc/man/"
    fish_add_path -g INFOPATH $INFOPATH "$HOME/.local/texlive/2026/texmf-dist/doc/info/"
